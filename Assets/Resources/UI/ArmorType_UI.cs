...
public class ArmorTypeUI : MonoBehaviour
{
    //Important Refers
    ...
    private GameObject ThisCreature;
    ...
    void Start()
    {
        ...
        GameObject ThisCreature = transform.parent.parent.gameObject;

        // 获取 TMP_Text 组件
        tmpText = GetComponent<TMP_Text>();        
        // 获取 Creature 组件
        TheCreature = ThisCreature.GetComponent<Creature>();
    ...
    private void Update()
    {
        tmpText.text = $"{TheCreature.ArmorType}";
